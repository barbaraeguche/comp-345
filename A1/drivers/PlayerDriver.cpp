...
void testPlayers() {
  ...
  auto* player1 = new Player("Alice");
  auto* player2 = new Player("Bob");
  auto* player3 = new Player(); // Default constructor
  ...
  auto* territory1 = new Territory("North America", 1);
  auto* territory2 = new Territory("South America", 2);
  auto* territory3 = new Territory("Europe", 3);
  auto* territory4 = new Territory("Asia", 4);
  auto* territory5 = new Territory("Africa", 5);
